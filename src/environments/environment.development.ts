export const environment = {
  ...
  apiUrl: "https://14xtw3qge5.execute-api.us-east-2.amazonaws.com/xihucalli",
  homeEndpoint: "/keyring",
  loginEndpoint: "/login-check",
  cognitoClientId: '24bhqe6lhqf7lpb7jkdph34m23',
  googleClientId: '305512890975-g05i0oid25onpsjjcptbv8cr0v3agb65.apps.googleusercontent.com',
  ...
  authInitiateEndpoint: '/user/auth/openid/initiate',
  authCallbackEndpoint: '/user/auth/openid/callback',
